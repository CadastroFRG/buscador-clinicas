...
if cep_input:
    ...
    if lat_ref and lon_ref:
        ...
        # Calcular tempo aproximado de viagem (km / velocidade média)
        VELOCIDADE_MEDIA_KMH = 50  # ajuste conforme necessário
        df_clinicas["TEMPO_HORAS"] = df_clinicas["DISTANCIA_KM"] / VELOCIDADE_MEDIA_KMH
        ...
        st.dataframe(
            resultados[["ENDERECO", "BAIRRO", "CIDADE", "CEP", "DISTANCIA_KM", "TEMPO_HORAS"]],
        ...
        for _, row in resultados.iterrows():
            folium.Marker(
                ...
                tooltip=f"{row['ENDERECO']} ({row['TEMPO_HORAS']:.1f}h de carro)",
